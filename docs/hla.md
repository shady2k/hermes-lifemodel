...
- **Soul-store (наш, источник истины):** идентичность (имя/природа/вайб/эмодзи), рамка отношений, инварианты/границы, веса темперамента (SDT), стиль конфликта, уровень проактивности; выросшее: желания (со статусом, в т.ч. отложенные), открытые петли/мысли, **выученная доступность/receptivity**, прозаические заметки, пороги нейронов.
