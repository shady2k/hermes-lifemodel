...
**Каталог видов — фиксированный** (виды в рантайме не выдумываются). Позвоночник — **BDI** (Belief–Desire–Intention; Bratman, Rao & Georgeff), а не граббэг типов. Концептуальное ядро (целевой минимум) проактивного контакта: **Desire · Intention · Relationship/Receptivity · Thought**; **живьём в этой фазе вживляется Desire**, остальные — модель + обвязка по мере задач. Следующим — **Commitment**; позже — Opinion/Prediction; **Observation — не вид, а provenance/trace**.
