...
| **Aggregator** | собрать сигналы, посчитать salience, решить «будить ли когницию» | нет |
...
Так *оба входа* (входящий ход и проактивный тик) пишут в **одно** состояние — консистентность закрыта.
...
_Draft v0.2 — D1–D6 решены, контракты §9–§12 добавлены по ревью Codex. Готово к вычитке и writing-plans._
